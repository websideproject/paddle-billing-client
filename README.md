...
[![Build status](https://github.com/bgervan/paddle-billing-client/workflows/build/badge.svg?branch=master&event=push)](https://github.com/bgervan/paddle-billing-client/actions?query=workflow%3Abuild)
...
```bash
cd paddle-billing-client && git init
```
...
git branch -M main
git remote add origin https://github.com/WebstormitDev/paddle-billing-client.git
